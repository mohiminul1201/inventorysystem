...
<section class="get-in-touch">
   ...
   <p class="text-center text-danger font-weight-bold">STOCK OUT</p>
   <form class="contact-form row" action="{{URL::to('s_add')}}" method="POST">
      {{ csrf_field() }}
      <div class="form-field col-lg-6">
         <input  class="input-text js-input" name="customer" type="text" autocomplete="off" required>
         <label class="label" for="name">Customer</label>
      </div>
      <div class="form-field col-lg-6 ">
          <input  class="input-text js-input" type="text" name="invoice_no" autocomplete="off" required>
